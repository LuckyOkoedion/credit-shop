...
@Service
public class AdminSecurityService implements ISecurityService {
    @Autowired
    ...
    public AdminSecurityService(CustomAdminDetailsService theUserDetailsService) {
    ...
    public void autoLogin(String username, String password) {
        ...
        if (usernamePasswordAuthenticationToken.isAuthenticated()) {
            ...
            logger.debug(String.format("Admin user auto login %s successfully!", username));
        }
    }
